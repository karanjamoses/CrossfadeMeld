...
const contractABI = require("../artifacts/contracts/Crossfademeld.sol/Crossfademeld.json").abi;

program
    .name("crossfademeld-cli")
    .description("CLI tool for Crossfademeld smart contract")
    .version("1.0.0");
