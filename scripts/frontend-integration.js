 ...
 * This file demonstrates how to integrate Crossfademeld with a web frontend
 */

// For React/Vue/Angular applications
export class CrossfademeldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CrossfademeldClient(provider, contractAddress);
